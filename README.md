...
Clone this repo into new project folder (e.g., `ngWebApp`).
```bash
git clone  https://github.com/xudao520/ngWebApp.git  ngWebApp
cd ngWebApp
```

We have no intention of updating the source on `angular/ngWebApp`.
